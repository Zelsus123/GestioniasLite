...
export const ClientDetails = ({ info, setInfo }) => {
  return (
    <Box
      sx={{
        width: "100%",
    ...
    >
      <Box sx={{ display: "flex", justifyContent: "center" }}>
        <Typography variant="h4">
          {info ? info.Cliente : "Seleccione un Cliente"}
        </Typography>
      </Box>
        ...
        <Box display="flex" flexDirection="column">
          ...
          <Box>
            <Typography variant="body2">
              {info ? info.Cedula : "Seleccione un Cliente"}
            </Typography>
          </Box>
        </Box>
        <Box>
          ...
          <Box>
            <Typography variant="body2">
              {info ? info.Direccion : "Seleccione un Cliente"}
            </Typography>
          </Box>
        </Box>
      </Box>
      ...
      >
        <Box>
          ...
          <Box>
            <Typography variant="body2">
              {info ? info.Telefono : "Seleccione un Cliente"}
            </Typography>
          </Box>
        </Box>
        <Box>
          ...
          <Box>
            <Typography variant="body2">
              {info ? info.Correo : "Seleccione un Cliente"}
            </Typography>
          </Box>
        </Box>
      </Box>
      ...
      >
        <Box>
          ...
          <Box>
            <Typography variant="body2">
              {info ? info.MontoDolares * 25 + " Bs" : "Seleccione un Cliente"}
            </Typography>
          </Box>
        </Box>
        <Box>
          ...
          <Box>
            <Typography variant="body2">
              {info ? info.MontoDolares + " $" : "Seleccione un Cliente"}
            </Typography>
          </Box>
        </Box>
      </Box>
