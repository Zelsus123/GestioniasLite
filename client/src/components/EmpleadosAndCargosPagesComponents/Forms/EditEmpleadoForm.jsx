...
import { editEmpleado } from "../../../features/crud/empleadosSlice";

export const EditEmpleadoForm = ({ editItem, setEdit, setEditItem }) => {
  ...
  const initialValues = {
    Empleado: editItem.Empleado,
    Cedula: editItem.Cedula,
    Cargo: editItem.Cargo,
    Salario: editItem.Salario,
    Contraseña: editItem.Contraseña,
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      dispatch(editEmpleado(EmpleadoEditado));
      setEditItem(null);
      setEdit(false);
    },
  });
